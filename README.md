...
- [BuyWhere/buywhere-mcp](https://github.com/BuyWhere/buywhere-mcp) 📇 ☁️ - Real-time product search, price comparison, and deal discovery across thousands of merchants for AI agents. Published as @buywhere/mcp-server.
